        ...
        Here, we focus on transparent opinions where technology, people, and data converge.  We offer a collective platform for teachers, students and administrators to interact through quiz and track real time progress.
          ...
          <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              Embark on a journey of discovery with our quiz site! Explore diverse topics, track your progress, and unleash your potential. Join us today and let the adventure begin!
              </div>
              {/* List */}
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <div className="flex justify-center items-baseline my-8">
              Elevate your teaching experience with our quiz platform! Craft interactive quizzes tailored to your curriculum, track progress in real-time. With our intuitive tools, you can create a dynamic learning environment that empowers your students!
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              {/* List */}
              <div className="flex justify-center items-baseline my-8">
              Optimize educational oversight effortlessly with our admin tools. Track user activity, manage quizzes, and enhance educational outcomes seamlessly. Join us today and elevate your administrative capabilities!
              </div>
